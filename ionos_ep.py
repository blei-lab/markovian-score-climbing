...
np.save('results/ionos_numiter'+str(num_iters)+'_prederror_ep.npy', pred_error)
np.save('results/ionos_numiter'+str(num_iters)+'_nu_ep.npy', nu_vec)
np.save('results/ionos_numiter'+str(num_iters)+'_lambda_ep.npy', lambda_mat)
np.save('results/ionos_numiter'+str(num_iters)+'_postpredval_ep.npy', np.array(post_pred_val))
