...
np.save('results/heart_S'+str(S)+'_stepsize'+str(step_size)+'_prederror_msc.npy', pred_error)
np.save('results/heart_S'+str(S)+'_stepsize'+str(step_size)+'_params_msc.npy', np.array(opt_params))
np.save('results/heart_S'+str(S)+'_stepsize'+str(step_size)+'_postpredval_msc.npy', np.array(post_pred_val))
