...
np.save('results/ionos_S'+str(S)+'_stepsize'+str(step_size)+'_prederror_is.npy', pred_error)
np.save('results/ionos_S'+str(S)+'_stepsize'+str(step_size)+'_params_is.npy', np.array(opt_params))
np.save('results/ionos_S'+str(S)+'_stepsize'+str(step_size)+'_postpredval_is.npy', np.array(post_pred_val))

print(np.array(opt_params))
